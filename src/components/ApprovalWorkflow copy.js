    ...
    <div className="min-h-screen bg-gray-50 flex flex-col items-center px-4">
      ...
      <main className="flex-grow flex flex-col items-center justify-center mt-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 w-full max-w-4xl">
          ...
          <Link
            to="/hod-approval"
            className="bg-purple-500 text-white p-6 rounded-lg shadow-md hover:shadow-lg transition-transform transform hover:scale-105 cursor-pointer"
          >
            <h2 className="text-2xl font-bold mb-2">HOD Management</h2>
            <p className="text-sm">
              Manage HODs, view profiles, and oversee department activities.
            </p>
          </Link>
        </div>
      </main>
